...
random_choice = ["Bread cheesecakes", "No egg cheesecakes", "Low amount cheese cheesecakes", 'Egg cheesecakes',
    ...
    if choice == 'a' or choice == 'A' or choice == 'a)' or choice == 'A)' and choice.isalpha() and len(choice) > 0:
        ...
        if choco == 'a' or choco == 'A' or choco == 'a)' or choco == 'A)':
            ...
            while cart.count('10 piece of Normal chocolate cheesecake without eggs.') == 0:
                try:
                    pieces = int(
                        input("And how many pieces of Normal chocolate cheesecake without eggs do you want?\n\n> "))
                    ...
                    if pieces == 1:
                        ...
                        cls()
                        print("Here is your order:\n\n{} pieces of Normal chocolate cheesecake without eggs.".format(
                            pieces))
